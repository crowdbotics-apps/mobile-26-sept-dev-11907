...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case types.API_V1_GGHTHGHJGJ_LIST:
    case types.API_V1_GGHTHGHJGJ_LIST_SUCCEEDED:
    case types.API_V1_GGHTHGHJGJ_LIST_FAILED:
    case types.API_V1_GGHTHGHJGJ_CREATE:
    case types.API_V1_GGHTHGHJGJ_CREATE_SUCCEEDED:
    case types.API_V1_GGHTHGHJGJ_CREATE_FAILED:
    case types.API_V1_GGHTHGHJGJ_READ:
    case types.API_V1_GGHTHGHJGJ_READ_SUCCEEDED:
    case types.API_V1_GGHTHGHJGJ_READ_FAILED:
    case types.API_V1_GGHTHGHJGJ_UPDATE:
    case types.API_V1_GGHTHGHJGJ_UPDATE_SUCCEEDED:
    case types.API_V1_GGHTHGHJGJ_UPDATE_FAILED:
    case types.API_V1_GGHTHGHJGJ_PARTIAL_UPDATE:
    case types.API_V1_GGHTHGHJGJ_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_GGHTHGHJGJ_PARTIAL_UPDATE_FAILED:
    case types.API_V1_GGHTHGHJGJ_DELETE:
    case types.API_V1_GGHTHGHJGJ_DELETE_SUCCEEDED:
    case types.API_V1_GGHTHGHJGJ_DELETE_FAILED:
